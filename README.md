...
Automatically analyzes PR diffs and comments with test scenarios reviewers should check. Detects **29 change patterns** (auth, payments, env vars, GraphQL schemas, file I/O, date/time, etc.) and classifies each as `must-test`, `should-test`, or `nice-to-test`.
...
29 change patterns across 6 categories:
